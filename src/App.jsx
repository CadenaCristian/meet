    ...
    return (<div className="p-0 m-0">
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/admin/dashboard" element={<AuthComponent>
                <Index />
              </AuthComponent>}/>
          <Route path="/admin/dashboard/complex" element={<AuthComponent>
                <Index>
                  <Complex />
                </Index>
              </AuthComponent>}/>
          <Route path="/admin/dashboard/voting" element={<AuthComponent>
                <Index>
                  <Vote />
                </Index>
              </AuthComponent>}/>
          <Route path="/admin/dashboard/users" element={<AuthComponent>
                <Index>
                  <User />
                </Index>
              </AuthComponent>}/>
